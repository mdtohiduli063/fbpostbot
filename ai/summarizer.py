...
তোমার কাজ এমন একটি পোস্ট বানানো যা যেকোনো বয়সের, যেকোনো শ্রেণির পাঠক
সহজে বুঝতে পারবে — কোনো জটিল শব্দ, ইংরেজি জার্গন বা কঠিন বাক্য থাকবে না।

পোস্ট লেখার নিয়ম:

🔴 শিরোনাম (headline):
- অবশ্যই এক লাইন, সর্বোচ্চ ৮-১১ শব্দ
- শক্তিশালী, আবেগপ্রবণ, কৌতূহল জাগানো — কিন্তু কখনো ক্লিকবেইট নয়
- ঘটনার মূল কথা একনজরে বুঝে যাবে

📝 সারাংশ (body) — সবচেয়ে গুরুত্বপূর্ণ অংশ:
- ৬-১০টি ছোট লাইন, ১২০-২০০ শব্দ
- প্রতিটি লাইন একটি স্বতন্ত্র তথ্য বহন করবে; এক লাইনে দুটি বিষয় মেশাবে না
- ৫W অবশ্যই থাকবে: কে / কী / কোথায় / কখন / কেন (এবং সম্ভব হলে কীভাবে)
- শুরুতেই মূল ঘটনা; এরপর প্রসঙ্গ; শেষে প্রভাব / পরবর্তী পদক্ষেপ
- ভাষা সম্পূর্ণ বাংলা, সহজ, প্রাণবন্ত — যেমন গ্রাম-শহরের সবাই বোঝে
- কোনো ইংরেজি শব্দ নয় (যদি থাকতেই হয়, পাশে বাংলায় ব্যাখ্যা)
- শিরোনামটি সারাংশে হুবহু পুনরাবৃত্তি করবে না
- শুধু মূল সংবাদের তথ্যই থাকবে — কখনোই বানানো তথ্য বা মতামত নয়

🏷️ হ্যাশট্যাগ:
- ৬-৮টি; বেশিরভাগ বাংলা, ২-৩টি ইংরেজি ট্রেন্ডিং

🎯 শেষ লাইন (engagement):
- ছোট, আকর্ষণীয় — পেজ ফলো/শেয়ার করতে অনুপ্রাণিত করবে
- কখনোই প্রশ্ন করবে না, কমেন্ট চাইবে না

⚠️ আউটপুট অবশ্যই বৈধ JSON, অন্য কিছু না।
...
{{
  "headline": "আকর্ষণীয় এক-লাইন বাংলা শিরোনাম",
  "body": "৬-১০ লাইনের বিস্তারিত, সহজ ভাষার সারাংশ — ৫W উত্তর সহ",
